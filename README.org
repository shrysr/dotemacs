...
#+hugo_custom_front_matter: :linktitle Dotemacs  :toc true
#+hugo_draft: false
...
*** TODO Use Deft for quick search through org-Brain
...
* frog buffer jump package

This is currently not on Melpa and therefore the git repo has been used. Note that external packages have been loaded [[nb:user::sr-config.org::c1897][here.]]

#+BEGIN_SRC shell :tangle no
cd ~/scimax/user/external_packages/
git clone https://github.com/waymondo/frog-jump-buffer.git
#+End_src

The frog-menu package is a pre-requisite.
...
This looks like a very handy package. It will take some time to master the shortcuts and the presented workflow. However it certainly looks like it will save a good bit of time.
